context('Export Advanced Pricing Notifications Failed Successful 6', () => {
    it('xlsx - sftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Advanced Pricing Export - notifications - failed - successful - xlsx - sftp')
            .should('have.value', 'Advanced Pricing Export - notifications - failed - successful - xlsx - sftp')
        ...
        cy.specifySftpSource('exportSftp' , '/chroot/home/a0563af8/develop-gold.dev.firebearstudio.com/pub/media/importexport/test/adv_price_failed_successful_notifications.xlsx')
