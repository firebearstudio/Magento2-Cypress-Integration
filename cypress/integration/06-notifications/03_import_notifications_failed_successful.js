context('Import Advanced Pricing Notifications Failed Successful 3', () => {
    it('add update - xlsx - sftp - new job', () => {
        ...
        cy.generalImportSectionWithoutReIndex('Advanced Pricing Import - notifications - failed - successful - xlsx - sftp')
