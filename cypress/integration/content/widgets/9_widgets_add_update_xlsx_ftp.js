context('Import Widgets', () => {
    it('add update - xlsx - ftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Widgets Import - add update - xlsx - ftp')
            .should('have.value', 'Widgets Import - add update - xlsx - ftp')
        ...
        cy.get('@ftpFilePath')
            .type('/files/test/widgets.xlsx')
            .should('have.value', '/files/test/widgets.xlsx')
