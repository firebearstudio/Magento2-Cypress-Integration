context('Import Сustomer Finances', () => {
    it('add update - xml - dropbox - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Customer Finance Import - add update - xml - dropbox')
            .should('have.value', 'Customer Finance Import - add update - xml - dropbox')
        ...
        cy.get('@dropboxFilePath')
            .type('/customer_finance.xml').should('have.value', '/customer_finance.xml')
