context('Export Customer Finances', () => {
    it('ods - sftp - new job', () => {
        ...
        cy.get('@sftpFilePath')
            .type('/var/www/alex/files/test/export_customer_finances_add_update.json')
            .should('have.value', '/var/www/alex/files/test/export_customer_finances_add_update.json')
