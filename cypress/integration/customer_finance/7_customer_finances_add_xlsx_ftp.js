context('Import Сustomer Finances', () => {
    it('add update - xlsx - ftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Customer Finances Import - add update - xlsx - ftp')
            .should('have.value', 'Customer Finances Import - add update - xlsx - ftp')
        ...
        cy.get('@ftpFilePath')
            .type('/files/test/customer_finance.xlsx')
            .should('have.value', '/files/test/customer_finance.xlsx')
