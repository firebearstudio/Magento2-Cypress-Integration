context('Import Stock Sources Delete Export File 11', () => {
    it('delete - export file - csv - sftp - new job', () => {
        ...
        cy.generalImportSectionWithoutReIndex('Stock Sources Import - export file - delete - csv - sftp')
        ...
        cy.specifySftpSource('importSftp','/chroot/home/a0563af8/develop-gold.dev.firebearstudio.com/pub/media/importexport/test/var/msi_stock_sources_filter.csv')
