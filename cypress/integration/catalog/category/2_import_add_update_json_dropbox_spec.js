...
context('Import Сategories', () => {
    it('add update - json - dropbox - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Category Import - add update - json - dropbox')
            .should('have.value', 'Category Import - add update - json - dropbox')
        ...
        cy.get('@dropboxFilePath')
            .type('/import_categories_add_update.json').should('have.value', '/import_categories_add_update.json')
