...
context('Import Attributes', () => {
    it('add update - csv - google sheet - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Attributes Import - add update - csv - google sheet')
            .should('have.value', 'Attributes Import - add update - csv - google sheet')
        ...
        cy.get('@googleFilePath')
            .invoke('val', 'https://docs.google.com/spreadsheets/d/13FemIzzexF5koAdQYjbcKscqoCfXyknYWkQkbSZGPsk/edit#gid=1515205707')
            .trigger('change')
