...
context('Import Attributes', () => {
    it('replace - csv - sftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Attributes Import - replace - csv - sftp')
            .should('have.value', 'Attributes Import - replace - csv - sftp')
        ...
        cy.get('@sftpFilePath')
            .type('/var/www/alex/files/import_attributes_replace.csv')
            .should('have.value', '/var/www/alex/files/import_attributes_replace.csv')
