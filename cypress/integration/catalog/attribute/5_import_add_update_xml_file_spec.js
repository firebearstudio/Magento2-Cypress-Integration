...
context('Import Attributes', () => {
    it(' only update - xml - file - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Attributes Import - add update - xml - file').should('have.value', 'Attributes Import - add update - xml - file')
        ...
        cy.get('@filePath')
            .type('pub/media/importexport/import_attributes_add_update.xml')
            .should('have.value', 'pub/media/importexport/import_attributes_add_update.xml')
