...
context('Import Attributes', () => {
    it('delete - ods - ftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Attributes Import - delete - ods - ftp')
            .should('have.value', 'Attributes Import - delete - ods - ftp')
        ...
        cy.get('@ftpFilePath')
            .type('/files/import_attributes_delete.ods')
            .should('have.value', '/files/import_attributes_delete.ods')
