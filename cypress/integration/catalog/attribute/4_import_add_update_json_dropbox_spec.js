...
context('Import Attributes', () => {
    it('only add - json - dropbox - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Attributes Import - add update - json - dropbox')
            .should('have.value', 'Attributes Import - add update - json - dropbox')
        ...
        cy.get('@dropboxFilePath')
            .type('/import_attributes_add_update.json').should('have.value', '/import_attributes_add_update.json')
