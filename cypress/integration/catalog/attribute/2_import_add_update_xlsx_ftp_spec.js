...
context('Import Attributes', () => {
    it('add update - xlsx - ftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Attributes Import - add update - xlsx - ftp')
            .should('have.value', 'Attributes Import - add update - xlsx - ftp')
        ...
        cy.get('@ftpFilePath')
            .type('/files/import_attribute_add_update_sample_data.xlsx')
            .should('have.value', '/files/import_attribute_add_update_sample_data.xlsx')
