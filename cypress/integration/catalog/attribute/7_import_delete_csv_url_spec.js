...
context('Import Attributes', () => {
    it('delete - csv - url - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Attributes Import - delete - csv - url')
            .should('have.value', 'Attributes Import - delete - csv - url')
        ...
        cy.get('@urlFilePath')
            .type('http://import.com/pub/media/importexport/import_attributes_delete.csv')
            .should('have.value', 'http://import.com/pub/media/importexport/import_attributes_delete.csv')
        ...
        cy.get('#debug-run').contains('Entity attribute',{timeout: 60000})
