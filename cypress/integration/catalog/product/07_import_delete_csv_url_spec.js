...
context('Import Products', () => {
    it('delete - csv - url - new job', () => {
        ...
        cy.generalImportSection('Product Import - delete - csv - url')
        ...
        cy.urlSource('http://alex-union.dev.firebearstudio.com/media/importexport/test/product_all_types.csv')
