...
context('Import Products', () => {
    it('delete - ods - ftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Product Import - delete - ods - ftp')
            .should('have.value', 'Product Import - delete - ods - ftp')
        ...
        cy.get('@ftpFilePath')
            .type('/files/import_delete.ods')
            .should('have.value', '/files/import_delete.ods')
        ...
        cy.get('#saves_and_run').click({force:true})
        cy.get('.run').click()
