...
context('Import Products', () => {
    it('delete - csv - url - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Product Import - delete - csv - url')
            .should('have.value', 'Product Import - delete - csv - url')
        ...
        cy.get('@urlFilePath')
            .type('http://import.com/pub/media/importexport/import_delete.csv')
            .should('have.value', 'http://import.com/pub/media/importexport/import_delete.csv')
