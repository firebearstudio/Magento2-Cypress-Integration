...
context('Import Advanced Pricing', () => {
    it('add update - xml - file - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Advanced Pricing Import - add update - xml - file').should('have.value', 'Advanced Pricing Import - add update - xml - file')
        ...
        cy.get('@filePath')
            .type('pub/media/importexport/import_advanced_pricing_add_update.xml')
            .should('have.value', 'pub/media/importexport/import_advanced_pricing_add_update.xml')
