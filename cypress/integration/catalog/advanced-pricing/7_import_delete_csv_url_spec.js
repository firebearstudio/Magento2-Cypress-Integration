...
context('Import Advanced Pricing', () => {
    it('delete - csv - url - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Advanced Pricing Import - delete - csv - url')
            .should('have.value', 'Advanced Pricing Import - delete - csv - url')
        ...
        cy.get('@settingsEntity').select('advanced_pricing');
        ...
        cy.get('@urlFilePath')
            .type('http://import.com/pub/media/importexport/import_advanced_pricing_delete.csv')
            .should('have.value', 'http://import.com/pub/media/importexport/import_advanced_pricing_delete.csv')
