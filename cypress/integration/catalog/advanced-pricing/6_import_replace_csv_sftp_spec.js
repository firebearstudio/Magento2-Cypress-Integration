...
context('Import Advanced Pricing', () => {
    it('replace - csv - sftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Advanced Pricing Import - replace - csv - sftp')
            .should('have.value', 'Advanced Pricing Import - replace - csv - sftp')
        ...
        cy.get('@sftpFilePath')
            .type('/var/www/alex/files/import_advanced_pricing_replace.csv')
            .should('have.value', '/var/www/alex/files/import_advanced_pricing_replace.csv')
