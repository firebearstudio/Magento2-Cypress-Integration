...
context('Import Сustomers Delete Csv Url 7', () => {
    it('delete - csv - url - new job', () => {
        ...
        cy.generalImportSection('Сustomer Import - delete - csv - url')
        ...
        cy.urlSource('https://4af610548f-253334.nxcli.net/media/importexport/test/customers_main.csv')
