...
context('Import Сustomers Allowed Assistance Disabled 23', () => {
    it('import customer allowed assistance disabled - new job', () => {
        //login
        ...
        cy.generalImportSection('Customer Import - allowed assistance - disabled')
        ...
        cy.fileSource('pub/media/importexport/test/customer_main_with_allowed_assistance_disabled.csv')
        ...
        cy.get('[data-index="extension_attributes.assistance_allowed"]').find('[name="customer[extension_attributes][assistance_allowed]"]').should('have.value','1')
    })
})
