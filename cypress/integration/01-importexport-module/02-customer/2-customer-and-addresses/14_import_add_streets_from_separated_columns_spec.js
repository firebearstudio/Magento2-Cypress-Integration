...
context('Import Customers and Addresses Add Streets From few columns 14', () => {
    it('add update - streets - new job', () => {
        //login
        ...
        cy.generalImportSection('Сustomers and Addresses Import - Add Streets from separated columns')
