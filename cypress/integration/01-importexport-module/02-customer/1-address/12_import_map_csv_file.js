...
context('Import Сustomer Addresses Mapping All rows 12', () => {
    it('add update - mapping - csv - file - new job', () => {
        ...
        cy.generalImportSection('Customer Address Import - mapping - all rows - file')
        ...
        cy.addMappingRowImport('.record-1','_website','_website_map')
        cy.addMappingRowImport('.record-2','_email','_email_map')
        cy.addMappingRowImport('.record-3','city','city_map')
