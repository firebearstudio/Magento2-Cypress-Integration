context('Export Export Jobs Filter 8', () => {
    it('xlsx - ftp - new job', () => {
        //login
        ...
        cy.specifySftpSource('exportSftp' , '/chroot/home/a0563af8/develop-gold.dev.firebearstudio.com/pub/media/importexport/test/var/export_export_jobs_entity_filter.csv')
