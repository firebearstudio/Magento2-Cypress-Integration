context('Export Import Jobs Filter 8', () => {
    it('xlsx - ftp - new job', () => {
        //login
        ...
        cy.get('.general_title ').find('input')
            .type('Import Jobs Export - xlsx - ftp')
            .should('have.value', 'Import Jobs Export - xlsx - ftp')
        ...
        cy.specifySftpSource('exportSftp' , '/chroot/home/a0563af8/develop-gold.dev.firebearstudio.com/pub/media/importexport/test/var/export_import_jobs_entity_filter.csv')
        ...
        cy.get('@sourceDataSystem').select('Import Jobs');
        ...
        cy.consoleExportResult('Entity import_jobs')
    })
})
