...
context('Export Orders Google Drive ods 7', () => {
    it('export - orders - google drive ods - new job', () => {
        //login
        ...
        cy.get('.general_title ').find('input')
            .type('Orders Export - google drive ods')
            .should('have.value', 'Orders Export - google drive ods')
        ...
        cy.get('[data-index="export_source_googledrive_file_path"]').find('input')
            .type('new/order-google-drive-test.ods',{force:true})
            .should('have.value','new/order-google-drive-test.ods')
