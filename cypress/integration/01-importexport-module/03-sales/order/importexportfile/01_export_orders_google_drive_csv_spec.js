...
context('Export Orders Google Drive csv 1', () => {
    it('export - orders - google drive csv - new job', () => {
        //login
        ...
        cy.get('.general_title ').find('input')
            .type('Orders Export - google drive csv')
            .should('have.value', 'Orders Export - google drive csv')
