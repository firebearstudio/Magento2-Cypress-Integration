...
context('Export Orders Google Drive json 9', () => {
    it('export - orders - google drive json - new job', () => {
        //login
        ...
        cy.get('.general_title ').find('input')
            .type('Orders Export - google drive json')
            .should('have.value', 'Orders Export - google drive json')
        ...
        cy.get('[data-index="export_source_googledrive_file_path"]').find('input')
            .type('new/order-google-drive-test.json',{force:true})
            .should('have.value','new/order-google-drive-test.json')
