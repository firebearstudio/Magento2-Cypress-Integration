...
context('Export Orders Google Drive xml 5', () => {
    it('export - orders - google drive xml- new job', () => {
        //login
        ...
        cy.get('.general_title ').find('input')
            .type('Orders Export - google drive xml')
            .should('have.value', 'Orders Export - google drive xml')
        ...
        cy.get('[data-index="export_source_googledrive_file_path"]').find('input')
            .type('new/order-google-drive-test.xml',{force:true})
            .should('have.value','new/order-google-drive-test.xml')
