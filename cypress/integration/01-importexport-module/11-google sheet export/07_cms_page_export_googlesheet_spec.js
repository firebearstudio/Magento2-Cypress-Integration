...
context('Export Cms Pages GoogleSheet 7',() => {
    it('export - googlesheet - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Cms Pages Export - googlesheet')
            .should('have.value', 'Cms Pages Export - googlesheet')
        ...
        cy.get('[name="export_source_google_sheet_id"]').type('917099383')
