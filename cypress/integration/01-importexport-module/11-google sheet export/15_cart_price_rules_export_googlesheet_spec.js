...
context('Export Cart Price Rules GoogleSheet 15',() => {
    it('export - googlesheet - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Cart Price Rules Export - googlesheet')
            .should('have.value', 'Cart Price Rules Export - googlesheet')
        ...
        cy.get('[name="export_source_google_sheet_id"]').type('546088040')
