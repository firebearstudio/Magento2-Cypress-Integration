...
context('Export Stock Sources GoogleSheet 1',() => {
    it('export - googlesheet - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Stock Sources Export - googlesheet')
            .should('have.value', 'Stock Sources Export - googlesheet')
        ...
        cy.get('[name="export_source_google_sheet_id"]').type('1756531896')
