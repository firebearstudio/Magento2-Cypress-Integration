...
context('Export Attributes GoogleSheet 9',() => {
    it('export - googlesheet - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Attributes Export - googlesheet')
            .should('have.value', 'Attributes Export - googlesheet')
        ...
        cy.get('[name="export_source_google_sheet_id"]').type('2109087744')
