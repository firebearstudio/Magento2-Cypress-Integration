...
context('Export Search Terms GoogleSheet 1',() => {
    it('export - googlesheet - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Search Terms Export - googlesheet')
            .should('have.value', 'Search Terms Export - googlesheet')
        ...
        cy.get('[name="export_source_google_sheet_id"]').type('317542677')
