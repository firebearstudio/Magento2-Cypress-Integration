...
context('Export Catalog Rule GoogleSheet 1',() => {
    it('export - googlesheet - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Catalog Rule Export - googlesheet')
            .should('have.value', 'Catalog Rule Export - googlesheet')
        ...
        cy.get('[name="export_source_google_sheet_id"]').type('828021920')
