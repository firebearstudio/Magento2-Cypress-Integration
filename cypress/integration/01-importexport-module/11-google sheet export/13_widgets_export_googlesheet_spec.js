...
context('Export Widgets GoogleSheet 13',() => {
    it('export - googlesheet - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Widgets Export - googlesheet')
            .should('have.value', 'Widgets Export - googlesheet')
        ...
        cy.get('[name="export_source_google_sheet_id"]').type('858123981')
