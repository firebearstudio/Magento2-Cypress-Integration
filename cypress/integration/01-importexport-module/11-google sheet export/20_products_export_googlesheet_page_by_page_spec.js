...
context('Export Products GoogleSheet Page By Page 20',() => {
    it('export - googlesheet - page by page - new job', () => {
        //login
        ...
        cy.get('.general_title ').find('input')
            .type('Products Export - page by page - googlesheet')
            .should('have.value', 'Products Export - page by page - googlesheet')
        ...
        cy.get('[name="export_source_google_sheet_id"]').type('1519975376')
