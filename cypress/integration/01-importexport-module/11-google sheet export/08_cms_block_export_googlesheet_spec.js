...
context('Export Cms Block GoogleSheet 8',() => {
    it('export - googlesheet - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Cms Block Export - googlesheet')
            .should('have.value', 'Cms Block Export - googlesheet')
        ...
        cy.get('[name="export_source_google_sheet_id"]').type('1748207876')
