...
context('Export Categories GoogleSheet 6',() => {
    it('export - googlesheet - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Categories Export - googlesheet')
            .should('have.value', 'Categories Export - googlesheet')
        ...
        cy.get('[name="export_source_google_sheet_id"]').type('1190660999')
