...
context('Export Newsletters Subscribers GoogleSheet 17',() => {
    it('export - googlesheet - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Newsletters Subscribers Export - googlesheet')
            .should('have.value', 'Newsletters Subscribers Export - googlesheet')
        ...
        cy.get('[name="export_source_google_sheet_id"]').type('886360047')
