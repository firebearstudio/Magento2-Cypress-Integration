...
context('Export Reviews GoogleSheet 14',() => {
    it('export - googlesheet - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Reviews Export - googlesheet')
            .should('have.value', 'Reviews Export - googlesheet')
        ...
        cy.get('[name="export_source_google_sheet_id"]').type('1594556991')
