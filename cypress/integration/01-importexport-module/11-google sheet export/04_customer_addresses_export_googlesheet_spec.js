...
context('Export Customer Addresses GoogleSheet 1',() => {
    it('export - googlesheet - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Customer Addresses Export - googlesheet')
            .should('have.value', 'Customer Addresses Export - googlesheet')
        ...
        cy.get('[name="export_source_google_sheet_id"]').type('767567919')
