...
context('Import Attributes Google Drive 4', () => {
    it('import attributes - google drive - new job', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Attributes Import - add update - csv - google drive')
        ...
        cy.get('[data-index="googledrive_googledrive_file_path"]').find('input').type('new/attributes.csv',{force:true})
        .should('have.value','new/attributes.csv')
