...
context('Export Customer Addresses Google Drive 15',() => {
    it('export - customer addresses  - google drive - new job', () => {
        //login
        ...
        cy.get('.general_title ').find('input')
            .type('Customer Addresses Export - google drive')
            .should('have.value', 'Customer Addresses Export - google drive')
        ...
        cy.get('[data-index="export_source_googledrive_file_path"]').find('input')
            .type('new/customer-address-google-drive-test.xlsx',{force:true})
            .should('have.value','new/customer-address-google-drive-test.xlsx')
