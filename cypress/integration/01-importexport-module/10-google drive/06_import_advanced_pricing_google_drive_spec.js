...
context('Import Adavnced Pricing Google Drive 6', () => {
    it('import advanced pricing - google drive - new job', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Advanced Pricing Import - add update - csv - google drive')
        ...
        cy.get('[data-index="googledrive_googledrive_file_path"]').find('input')
            .type('new/advanced_pricing.csv',{force:true})
            .should('have.value','new/advanced_pricing.csv')
