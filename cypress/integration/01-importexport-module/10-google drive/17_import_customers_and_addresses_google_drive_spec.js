...
context('Import Customer And Addresses Google Drive 17', () => {
    it('import customer and addresses - google drive - new job', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Customer And Addresses Import - add update - csv - google drive')
        ...
        cy.get('[data-index="googledrive_googledrive_file_path"]').find('input')
            .type('new/customers_and_addresses.csv',{force:true})
            .should('have.value','new/customers_and_addresses.csv')
