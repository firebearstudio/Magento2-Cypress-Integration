...
context('Export Customer Main Google Drive 13',() => {
    it('export - customer main - google drive - new job', () => {
        //login
        ...
        cy.get('.general_title ').find('input')
            .type('Customer Main Export - google drive')
            .should('have.value', 'Customer Main Export - google drive')
        ...
        cy.get('[data-index="export_source_googledrive_file_path"]').find('input')
            .type('new/customer-main-google-drive-test.xlsx',{force:true})
            .should('have.value','new/customer-main-google-drive-test.xlsx')
