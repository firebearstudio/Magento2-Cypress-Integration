...
context('Import Customer Addresses Google Drive 16', () => {
    it('import customer addresses - google drive - new job', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Customer Addresses Import - add update - csv - google drive')
        ...
        cy.get('[data-index="googledrive_googledrive_file_path"]').find('input')
            .type('new/customer_addresses.csv',{force:true})
            .should('have.value','new/customer_addresses.csv')
