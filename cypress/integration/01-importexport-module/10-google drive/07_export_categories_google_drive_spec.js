...
context('Export Categories Google Drive 7',() => {
    it('export - categories - google drive - new job', () => {
        //login
        ...
        cy.get('.general_title ').find('input')
            .type('Categories Export - google drive')
            .should('have.value', 'Categories Export - google drive')
        ...
        cy.get('[data-index="export_source_googledrive_file_path"]').find('input')
            .type('new/categories-google-drive-test.xlsx',{force:true})
            .should('have.value','new/categories-google-drive-test.xlsx')
