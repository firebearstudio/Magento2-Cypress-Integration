...
context('Import Categories Google Drive 8', () => {
    it('import categories - google drive - new job', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Categoties Import - add update - csv - google drive')
        ...
        cy.get('[data-index="googledrive_googledrive_file_path"]').find('input')
            .type('new/categories.csv',{force:true})
            .should('have.value','new/categories.csv')
