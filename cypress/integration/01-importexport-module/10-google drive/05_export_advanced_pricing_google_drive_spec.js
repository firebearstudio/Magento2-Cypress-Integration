...
context('Export Advanced Pricing Google Drive 5',() => {
    it('export - advnaced pricing - google drive - new job', () => {
        //login
        ...
        cy.get('.general_title ').find('input')
            .type('Advanced Pricing Export - google drive')
            .should('have.value', 'Advanced Pricing Export - google drive')
        ...
        cy.get('[data-index="export_source_googledrive_file_path"]').find('input')
            .type('new/advanced-pricing-google-drive-test.xlsx',{force:true})
            .should('have.value','new/advanced-pricing-google-drive-test.xlsx')
