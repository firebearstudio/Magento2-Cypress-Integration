context('Import Advanced Pricing Notifications Failed 1', () => {
    it('add update - xlsx - sftp - new job', () => {
        ...
        cy.generalImportSectionWithoutReIndex('Advanced Pricing Import - notifications - failed - xlsx - sftp')
        ...
        cy.get('@notificationType').select('Failed Jobs',{force:true})
        ...
        cy.get('@notificationSender').select('general',{force:true})
