...
context('Import Customer Addresses One Drive 12', () => {
    it('one drive - new job', () => {
        ...
        cy.generalImportSectionWithoutReIndex('Customer Addresses Import - one drive')
        ...
        cy.get('[data-index="onedrive_onedrive_file_path"]').find('[name="onedrive_file_path"]')
            .type('export/customer_addresses.csv',{force:true})
