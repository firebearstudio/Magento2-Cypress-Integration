...
context('Export Categories One Drive 7',() => {
    it('export - one drive - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Categories Export - one drive')
            .should('have.value', 'Categories Export - one drive')
        ...
        cy.get('[name="export_source_onedrive_file_path"]').type('/export/categories.csv',{force:true})
            .should('have.value', '/export/categories.csv')
