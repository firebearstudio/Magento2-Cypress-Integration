context('Import Cms Block Delete Xml Url 8', () => {
    it('delete - xml - url - new job', () => {
        ...
        cy.generalImportSectionWithoutReIndex('Cms Block Import - delete - xml - url')
        ...
        cy.urlSource('https://4af610548f-253334.nxcli.net/media/importexport/test/cms_blocks.xml')
