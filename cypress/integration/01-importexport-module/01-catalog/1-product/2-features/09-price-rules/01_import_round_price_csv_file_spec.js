...
context('Import Products Round Price 1',{ retries: 0 }, () => {
    it('round price - csv - file - new job', () => {
        ...
        cy.get('[data-index="container_price"]',{timeout: 20000}).find('[data-index="advanced_pricing_button"]').click({force:true})
