...
context('Import Products Clear Attr Value 6',{ retries: 3 }, () => {
    it('add update - csv - sftp - new job', () => {
        ...
        cy.generalImportSectionWithoutReIndex('Product Import - clear attr value')
        ...
        //check that color ,size values were cleared
        ...
        cy.get('[data-index="color"]',{timeout: 10000}).find('[data-title="Gray"]').should('not.be.selected')
        cy.get('[data-index="size"]').find('[data-title="S"]').should('not.be.selected')
