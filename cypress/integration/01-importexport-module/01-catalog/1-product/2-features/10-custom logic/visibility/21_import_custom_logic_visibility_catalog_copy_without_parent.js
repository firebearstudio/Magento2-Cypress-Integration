...
context('Import Products Custom logic Visibility Catalog Copy Without Parent 21',{ retries: 0 }, () => {
    it('custom logic - visibility - Catalog - copy - without parent', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Product Import - custom logic - copy - visibility - catalog  - Without parent')
