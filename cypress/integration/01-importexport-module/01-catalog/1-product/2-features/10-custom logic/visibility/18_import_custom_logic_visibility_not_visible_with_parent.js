...
context('Import Products Custom logic Visibility Not Visible With Parent 18',{ retries: 0 }, () => {
    it('custom logic - visibility - Not Visible - With parent', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Product Import - custom logic - visibility - not visible - WITH parent')
