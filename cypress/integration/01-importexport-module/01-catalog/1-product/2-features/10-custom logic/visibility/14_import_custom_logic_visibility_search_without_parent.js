...
context('Import Products Custom logic Visibility Search Without Parent 14',{ retries: 0 }, () => {
    it('custom logic - visibility - Search - without parent', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Product Import - custom logic - visibility - search  - Without parent')
