...
context('Import Products Custom logic Visibility Catalog/Search Without Parent 11',{ retries: 0 }, () => {
    it('custom logic - visibility - catalog/search - without parent', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Product Import - custom logic - visibility - catalog/search  - Without parent')
        ...
        cy.get('table',{timeout:40000}).contains('visibility-one-S-Gray',{timeout:40000}).parentsUntil('tbody')
            .within(function () {
