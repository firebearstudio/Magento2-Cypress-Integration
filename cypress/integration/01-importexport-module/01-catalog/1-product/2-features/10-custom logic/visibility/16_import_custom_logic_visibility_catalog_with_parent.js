...
context('Import Products Custom logic Visibility Catalog With Parent 16',{ retries: 0 }, () => {
    it('custom logic - visibility - Catalog - With parent', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Product Import - custom logic - visibility - catalog - WITH parent')
