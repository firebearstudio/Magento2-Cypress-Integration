...
context('Import Products Custom logic Visibility Search Copy With Parent 23',{ retries: 0 }, () => {
    it('custom logic - visibility - Search - Copy - With parent', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Product Import - custom logic - copy - visibility - search - WITH parent')
        ...
        cy.fileSource('pub/media/importexport/test/products_custom_logic_visibility_search_with_parent.csv')
