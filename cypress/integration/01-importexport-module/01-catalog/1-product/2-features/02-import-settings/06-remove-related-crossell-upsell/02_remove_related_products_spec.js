...
context('Import Products Remove Related/Crossell/Upsell products 02',{ retries: 0 }, () => {
    it('remove related/crossell/upsell products - add update -  csv - file - new job', () => {
        ...
        cy.get('[data-index="related"]',{timeout: 30000}).find('.fieldset-wrapper-title').click({force:true});
