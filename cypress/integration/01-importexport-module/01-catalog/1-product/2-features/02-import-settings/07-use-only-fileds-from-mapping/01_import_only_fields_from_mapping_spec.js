...
context('Import Products Only Fields From Mapping 1',{ retries: 0 }, () => {
    it(' only mapping fields - csv - file - new job', () => {
        ...
        cy.get('[name="sku"]',{timeout: 10000}).invoke('val', 'product-only-mapping').trigger('change',{force:true})
        ...
        cy.get('.admin__data-grid-outer-wrap').contains('product-only-mapping-field10',{timeout: 20000})
