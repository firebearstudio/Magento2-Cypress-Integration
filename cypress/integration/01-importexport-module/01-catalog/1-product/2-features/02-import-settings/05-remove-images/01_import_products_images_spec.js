...
context('Import Products Images 1',{ retries: 0 }, () => {
    it('import - products - images', () => {
        ...
        cy.get('.admin__data-grid-outer-wrap').contains('fruit1').click({force:true});
         ...
         cy.get('#media_gallery_content').find('[src="https://7992002a43-1276088.nxcli.net/media/catalog/product/1/e/1e756be2f3bc257db3ae612cd253e21159438399e78487d8687016a5281c4e6c.jpeg"]',{timeout: 10000}).click()
