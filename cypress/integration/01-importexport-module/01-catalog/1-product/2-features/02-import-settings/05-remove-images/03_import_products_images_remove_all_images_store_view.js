...
context('Import Products Images Remove All Images Enabled 3',{ retries: 0 }, () => {
    it('import - products - images - remove - all - images - enabled - specific store view', () => {
        ...
        cy.get('.admin__data-grid-outer-wrap').contains('fruit1',{timeout: 20000})
        ...
        cy.get('[data-index="gallery"]',{timeout: 30000}).find('.fieldset-wrapper-title').click({force:true});
        cy.get('#media_gallery_content').find('[src="https://7992002a43-1276088.nxcli.net/media/catalog/product/2/3/2315de17772796a58e28741b6aed243472da1fd48cde623c29af655c2d44e442.jpeg"]',{timeout: 30000}).should('not.exist')
        cy.get('#media_gallery_content').find('[src="https://7992002a43-1276088.nxcli.net/media/catalog/product/1/e/1e756be2f3bc257db3ae612cd253e21159438399e78487d8687016a5281c4e6c.jpeg"]').click()
