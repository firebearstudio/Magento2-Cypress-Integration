...
context('Import Products Custom logic Copy Values to Configurable 8',{ retries: 3 }, () => {
    it('custom logic - copy - values - to - configurable', () => {
        ...
        cy.get('[data-index="test2"]').find('select').select('1')
        cy.get('[data-index="test3"]').find('select').select('1')
        cy.get('[data-index="test4"]').find('select').select('1')
        cy.get('[data-index="test5"]').find('select').select('1')
