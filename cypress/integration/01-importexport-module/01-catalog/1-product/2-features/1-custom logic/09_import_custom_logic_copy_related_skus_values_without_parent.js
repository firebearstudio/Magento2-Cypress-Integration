...
context('Import Products Custom logic Copy Related Skus Values Without Parent 9',{ retries: 3 }, () => {
    it('custom logic - copy - related skus - without parent', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Product Import - custom logic - copy - related skus values - Without parent')
        ...
        cy.fileSource('pub/media/importexport/test/products_custom_logic_copy_related_skus_without_config.csv')
        ...
        cy.get('[name="sku"]').invoke('val', 'related-without-config').trigger('change',{force:true})
        ...
        //delete 'related-without-config' products
