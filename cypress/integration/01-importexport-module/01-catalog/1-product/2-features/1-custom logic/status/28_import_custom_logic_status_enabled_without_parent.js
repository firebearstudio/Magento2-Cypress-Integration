...
context('Import Products Custom logic Status Enabled Without Parent 28',{ retries: 0 }, () => {
    it('custom logic - status - enabled - without parent', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Product Import - custom logic - status - enabled  - Without parent')
