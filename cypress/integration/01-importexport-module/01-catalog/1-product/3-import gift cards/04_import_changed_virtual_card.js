...
context('Import Products', () => {
    it('changed values - virtual gift card', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Virtual Gift Card Import - changed values')
        ...
        cy.get('[data-index="gift_wrapping_price"]').find('input').should('have.value','9.00')
    })
})
