...
context('Import Products', () => {
    it('changed values - combined gift card', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Combined Gift Card Import - changed values')
        ...
        cy.get('[data-index="lifetime"]').find('input').should('have.value', '23')
        ...
        cy.get('[data-index="gift_wrapping_price"]').find('input').should('have.value','13.00')
    })
})
