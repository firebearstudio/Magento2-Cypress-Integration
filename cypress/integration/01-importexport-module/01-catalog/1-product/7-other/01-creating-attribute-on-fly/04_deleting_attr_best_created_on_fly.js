...
context('Deleting attribute best that was created on fly 4', () => {
    it('deleting attr best on fly ', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Attributes Delete - best - created on fly')
        ...
        cy.fileSource('pub/media/importexport/test/attributes_best_SUPPORT-15833.csv',{force:true})
