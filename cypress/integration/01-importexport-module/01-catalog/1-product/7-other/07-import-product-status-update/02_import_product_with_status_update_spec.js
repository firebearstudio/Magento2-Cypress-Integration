...
context('Import Products with status update 2', () => {
    it('import products with status update - new job', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Product Import - with status update')
        ...
        cy.fileSource('pub/media/importexport/test/product-update-status-import2.csv',{force:true})
