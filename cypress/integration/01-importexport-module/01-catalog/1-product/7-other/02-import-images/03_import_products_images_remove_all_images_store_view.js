...
context('Import Products Images Remove All Images Enabled 3',{ retries: 0 }, () => {
    it('import - products - images - remove - all - images - enabled - specific store view', () => {
        ...
        cy.get('#media_gallery_content').find('[src="https://bcb62cd561-254704.nxcli.net/media/catalog/product/2/3/2315de17772796a58e28741b6aed243472da1fd48cde623c29af655c2d44e442.jpeg"]',{timeout: 30000}).should('not.exist')
