...
context('Import Products Images Labels Update 7',{ retries: 0 }, () => {
    it('import - products - images - labels - update 7', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Product Import - images labels import')
       ...
       cy.googlePathSource('https://docs.google.com/spreadsheets/d/13FemIzzexF5koAdQYjbcKscqoCfXyknYWkQkbSZGPsk/edit#gid=1164219475')
        ...
        //specify general section
        cy.generalImportSectionWithoutReIndex('Product Import - images labels update')
        ...
        //specify Import Source section
        cy.fileSource('pub/media/importexport/test/products_updating_image_labels_all_store_views.csv')
        ...
        cy.get('[name="store_id"]').select('All Store Views',{force: true})
        ...
        cy.get('@firstImage').find('.item-description').contains('New text')
