...
context('Import Products XLSX Fle List1 20', () => {
    it(' xlsx - file - list1 - new job', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Product Import - xlsx - file - list1')
        ...
        cy.get('[data-index="xlsx_sheet"]').find('[name="xlsx_sheet"]').select('Sheet1') //choose specific list
        ...
        cy.get('#debug-run').contains('Updated: 18 rows')
    })
})
