...
context('Export Products Mapping 11', () => {
    it('mapping - xlsx - sftp - new job', () => {
        //login
        ...
        cy.get('.general_title ').find('input')
            .type('Product Export - mapping - xlsx - sftp')
            .should('have.value', 'Product Export - mapping - xlsx - sftp')
        ...
        cy.specifySftpSource('exportSftp' , '/chroot/home/a0563af8/develop-gold.dev.firebearstudio.com/pub/media/importexport/test/var/export_products_map.xlsx')
