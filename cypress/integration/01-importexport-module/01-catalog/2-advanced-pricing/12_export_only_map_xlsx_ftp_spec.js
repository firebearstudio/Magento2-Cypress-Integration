context('Export Advanced Pricing Only Mapping 12', () => {
    it('xlsx - sftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Advanced Pricing Export - only mapping - xlsx - sftp')
            .should('have.value', 'Advanced Pricing Export - only mapping - xlsx - sftp')
