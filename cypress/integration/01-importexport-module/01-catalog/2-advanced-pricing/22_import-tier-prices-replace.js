context('Import Advanced Pricing replace 22', () => {
    it('replace behavior - new job', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Advanced Pricing Import - replace - behavior 22')
       ...
       cy.get('@tierPriceGrid').find('tr').should('have.length', 2)
