context('Import Сategories Replace Csv Sftp 6', () => {
    it('replace - csv - sftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
           .type('Category Import - replace - csv - sftp')
           .should('have.value', 'Category Import - replace - csv - sftp')
        ...
        cy.specifySftpSource('importSftp','/chroot/home/a0563af8/develop-alpha.dev.firebearstudio.com/pub/media/importexport/test/categories.csv',{force:true})
