...
context('Import Сategories Import Using Export Filter File 15', () => {
    it('add update - xlsx - sftp - new job', () => {
        ...
        cy.specifySftpSource('importSftp','/chroot/home/a0563af8/develop-alpha.dev.firebearstudio.com/pub/media/importexport/test/var/export_categories_filter.xlsx',{force:true})
