context('Import Attributes Xml Using Export File 6', () => {
    it('add update - xml - sftp - new job', () => {
        ...
        cy.generalImportSectionWithoutReIndex('Attributes Import - using export file - xml - sftp')
        ...
        cy.specifySftpSource('importSftp','/chroot/home/a0563af8/develop-alpha.dev.firebearstudio.com/pub/media/importexport/test/var/export_attrbiutes.xml',{force:true})
