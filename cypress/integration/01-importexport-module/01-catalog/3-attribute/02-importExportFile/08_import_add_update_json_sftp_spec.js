context('Import Attributes Json Using Export File 8', () => {
    it('add update - json - sftp - new job', () => {
        ...
        cy.generalImportSectionWithoutReIndex('Attributes Import - using export file - json - sftp')
        ...
        cy.specifySftpSource('importSftp','/chroot/home/a0563af8/develop-alpha.dev.firebearstudio.com/pub/media/importexport/test/var/export_attrbiutes.json',{force:true})
