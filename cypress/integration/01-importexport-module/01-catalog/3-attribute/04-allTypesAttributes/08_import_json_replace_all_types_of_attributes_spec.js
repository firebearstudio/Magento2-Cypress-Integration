...
context('Import Attributes Json All Types 8', () => {
    it('all types - replace - json - file - new job', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Attributes Import - json - replace - All Types')
        ...
        cy.fileSource('pub/media/importexport/test/attributes_all_types.json',{force:true})
