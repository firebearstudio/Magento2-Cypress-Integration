...
context('Import Attributes Ods All Types 14', () => {
    it('all types - replace - ods - file - new job', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Attributes Import - ods - replace - All Types')
        ...
        cy.fileSource('pub/media/importexport/test/attributes_all_types.ods',{force:true})
    ...
    it('checking import attribute test_text_filed', () => {
        ...
        cy.get('#advanced_fieldset-wrapper > .fieldset-wrapper-title > .admin__collapsible-title').click({force: true})
