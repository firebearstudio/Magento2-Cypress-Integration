...
context('Import Attributes Xml All Types 6', () => {
    it('all types - delete - xml - file - new job', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Attributes Import - xml - delete - All Types')
