...
context('Import Attributes Xlsx All Types 11', () => {
    it('all types - replace - xlsx - file - new job', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Attributes Import - xlsx - replace - All Types')
