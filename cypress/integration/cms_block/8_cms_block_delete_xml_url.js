context('Import Cms Block', () => {
    it('delete - xml - url - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Cms Block Import - delete - xml - url')
            .should('have.value', 'Cms Block Import - delete - xml - url')
        ...
        cy.get('@urlFilePath')
            .type('http://alex-union.dev.firebearstudio.com/media/importexport/test/cms_blocks.xml')
            .should('have.value', 'http://alex-union.dev.firebearstudio.com/media/importexport/test/cms_blocks.xml')
