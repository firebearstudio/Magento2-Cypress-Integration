context('Import Cms Block', () => {
    it('delete - export file - csv - sftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Cms Block Import - export file - delete - csv - sftp')
            .should('have.value', 'Cms Block Import - export file - delete - csv - sftp')
        ...
        cy.get('@sftpFilePath')
            .type('/var/www/alex/files/test/export_cms_block.csv')
            .should('have.value', '/var/www/alex/files/test/export_cms_block.csv')
