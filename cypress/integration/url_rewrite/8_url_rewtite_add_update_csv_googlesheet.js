context('Import Url Rewrites', () => {
    it('add update - csv - google sheet - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Url Rewrites Import - add update - csv - google sheet')
            .should('have.value', 'Url Rewrites Import - add update - csv - google sheet')
        ...
        cy.get('@googleFilePath')
            .invoke('val', 'https://docs.google.com/spreadsheets/d/13FemIzzexF5koAdQYjbcKscqoCfXyknYWkQkbSZGPsk/edit#gid=1237471602')
            .trigger('change')
