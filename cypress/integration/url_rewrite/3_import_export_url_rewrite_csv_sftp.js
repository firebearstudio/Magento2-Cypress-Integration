context('Import Url Rewrites', () => {
    it('add update - csv - sftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Url Rewrites Import - export file - add update - csv - sftp')
            .should('have.value', 'Url Rewrites Import - export file - add update - csv - sftp')
        ...
        cy.get('@sftpFilePath')
            .type('/var/www/alex/files/test/export_url_rewrite.csv')
            .should('have.value', '/var/www/alex/files/test/export_url_rewrite.csv')
