...
context('Export Customer Addresses One Drive 11',() => {
    it('export - one drive - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Customer Addresses Export - one drive')
            .should('have.value', 'Customer Addresses Export - one drive')
        ...
        cy.get('[name="export_source_onedrive_file_path"]').type('/export/customer_addresses.csv',{force:true})
            .should('have.value', '/export/customer_addresses.csv')
