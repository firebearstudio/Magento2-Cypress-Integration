...
context('Import Advanced Pricing One Drive 4', () => {
    it('one drive - new job', () => {
        ...
        cy.generalImportSectionWithoutReIndex('Advanced Pricing Import - one drive')
        ...
        cy.get('[data-index="onedrive_onedrive_file_path"]').find('[name="onedrive_file_path"]')
            .type('export/advanced_pricing.csv',{force:true})
