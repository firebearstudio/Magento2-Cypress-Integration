...
context('Export Order One Drive 14',() => {
    it('export - one drive - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Order Export - one drive')
            .should('have.value', 'Order Export - one drive')
        ...
        cy.get('[name="export_source_onedrive_file_path"]').type('/export/order.csv',{force:true})
            .should('have.value', '/export/order.csv')
