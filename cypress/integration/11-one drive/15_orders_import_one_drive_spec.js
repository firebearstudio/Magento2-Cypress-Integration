...
context('Import Order One Drive 15', () => {
    it('one drive - new job', () => {
        ...
        cy.generalImportSectionWithoutReIndex('Order Import - one drive')
        ...
        cy.get('[data-index="onedrive_onedrive_file_path"]').find('[name="onedrive_file_path"]')
            .type('test/orders.csv',{force:true})
            .should('have.value', 'test/orders.csv')
