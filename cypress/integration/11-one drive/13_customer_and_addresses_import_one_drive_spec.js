...
context('Import Customer And Addresses One Drive 13', () => {
    it('one drive - new job', () => {
        ...
        cy.generalImportSectionWithoutReIndex('Customer And Addresses Import - one drive')
        ...
        cy.get('[data-index="onedrive_onedrive_file_path"]').find('[name="onedrive_file_path"]')
            .type('test/customers_and_addresses.csv',{force:true})
            .should('have.value', 'test/customers_and_addresses.csv')
