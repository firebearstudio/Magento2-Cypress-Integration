context('Export Stock Sources Mapping 9', () => {
    it('csv - sftp - new job', () => {
        //login
        ...
        cy.specifySftpSource('exportSftp','/chroot/home/a0563af8/develop-gold.dev.firebearstudio.com/pub/media/importexport/test/var/msi_stock_sources_map.csv')
