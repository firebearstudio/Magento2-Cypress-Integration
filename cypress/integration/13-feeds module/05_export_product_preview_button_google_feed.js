...
context('Export Products Preview Button Google Feed 5',() => {
    it('products - preview - button - google - feed', () => {
        //login
        ...
        cy.get('.general_title ').find('input')
            .type('Product Export - Preview Button - Google Feed')
            .should('have.value', 'Product Export - Preview Button - Google Feed')
        ...
        cy.get('#feed_template_selector').select('google_shopping')
        cy.get('[name="source_category_feed_mapping_list"]').select('Google Feed')

        //specify Import Source section
        cy.specifySftpSource('exportSftp' , '/chroot/home/a0563af8/develop-gold.dev.firebearstudio.com/pub/media/importexport/test/var/export_google_feed_products.xml')
        ...
        cy.get('#debug-run').contains('Exported 10 items.',{timeout: 40000})
    })
})
