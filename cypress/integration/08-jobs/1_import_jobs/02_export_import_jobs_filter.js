context('Export Import Jobs Filter 2', () => {
    it('xlsx - sftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Import Jobs Export - xlsx - sftp')
            .should('have.value', 'Import Jobs Export - xlsx - sftp')
        ...
        cy.specifySftpSource('exportSftp' , '/chroot/home/a0563af8/develop-gold.dev.firebearstudio.com/pub/media/importexport/test/var/export_import_jobs_filter.csv')
