context('Import Catalog Rule', () => {
    it('add - xlsx - ftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Catalog Rule Import - add - xlsx - ftp')
            .should('have.value', 'Catalog Rule Import - add - xlsx - ftp')
        ...
        cy.get('@ftpFilePath')
            .type('/files/test/catalog_rules.xlsx')
            .should('have.value', '/files/test/catalog_rules.xlsx')
