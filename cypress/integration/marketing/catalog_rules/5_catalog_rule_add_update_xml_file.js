    ...
    it(' add  - map - csv - file - new job', () => {
       ...
       cy.get('@loginButton').click()
        ...
        cy.get('.general_title ').find('input')
            .type('Catalog Rule Import - add - map - csv - file')
            .should('have.value', 'Catalog Rule Import - add - map - csv - file')
        ...
        cy.get('@filePath')
            .type('pub/media/importexport//c/a/catalog_rules_map.csv')
            .should('have.value', 'pub/media/importexport//c/a/catalog_rules_map.csv')
