context('Import Catalog Rule', () => {
    it('add - ods - dropbox - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Catalog Rule Import - add  - ods - dropbox')
            .should('have.value', 'Catalog Rule Import - add  - ods - dropbox')
        ...
        cy.get('@dropboxFilePath')
            .type('/catalog_rules.ods').should('have.value', '/catalog_rules.ods')
