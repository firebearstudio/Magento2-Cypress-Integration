context('Import Catalog Rules', () => {
    it('add update - csv - sftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Catalog Rules Import - export file - add update - csv - sftp')
            .should('have.value', 'Catalog Rules Import - export file - add update - csv - sftp')
        ...
        cy.get('@sftpFilePath')
            .type('/var/www/alex/files/test/export_catalog_rules.csv')
            .should('have.value', '/var/www/alex/files/test/export_catalog_rules.csv')
