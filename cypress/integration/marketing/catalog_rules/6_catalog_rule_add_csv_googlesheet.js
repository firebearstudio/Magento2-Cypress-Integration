context('Import Catalog Rule', () => {
    it('add update - csv - google sheet - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Catalog Rule Import - add update - csv - google sheet')
            .should('have.value', 'Catalog Rule Import - add update - csv - google sheet')
        ...
        cy.get('@googleFilePath')
            .invoke('val', 'https://docs.google.com/spreadsheets/d/1mwxERkfGsPiUqtju9P4sp7S_JGS8OG1f4f3G2KmfU6w/edit#gid=1864097332')
            .trigger('change')
        ...
        cy.get('#debug-run').contains('catalog_rule',{timeout: 600000})
