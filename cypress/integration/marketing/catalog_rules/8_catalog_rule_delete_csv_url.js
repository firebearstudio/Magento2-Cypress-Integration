context('Import Catalog Rule', () => {
    it('delete - csv - url - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Catalog Rule Import - delete - csv - url')
            .should('have.value', 'Catalog Rule Import - delete - csv - url')
        ...
        cy.get('@urlFilePath')
            .type('http://alex-union.dev.firebearstudio.com/media/importexport/test/catalog_rules.csv')
            .should('have.value', 'http://alex-union.dev.firebearstudio.com/media/importexport/test/catalog_rules.csv')
        ...
        cy.get('#debug-run').contains('Entity catalog_rule',{timeout: 600000})
