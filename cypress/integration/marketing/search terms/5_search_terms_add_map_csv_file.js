context('Import Search Terms', () => {
    it(' add  - map - csv - file - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Search Terms Import - add - map - csv - file')
            .should('have.value', 'Search Terms Import - add - map - csv - file')
        ...
        cy.get('@filePath')
            .type('pub/media/importexport//s/e/search_terms_map.csv')
            .should('have.value', 'pub/media/importexport//s/e/search_terms_map.csv')
