context('Import Search Terms', () => {
    it('add - xlsx - ftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Search Terms Import - add - xlsx - ftp')
            .should('have.value', 'Search Terms Import - add - xlsx - ftp')
        ...
        cy.get('@ftpFilePath')
            .type('/files/test/search_terms.xlsx')
            .should('have.value', '/files/test/search_terms.xlsx')
