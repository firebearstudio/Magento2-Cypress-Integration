context('Import Search Terms', () => {
    it('delete - csv - url - new job', () => {
        ...
        cy.generalImportSection('Search Terms Import - delete - csv - url')
        ...
        cy.urlSource('http://alex-union.dev.firebearstudio.com/media/importexport/test/search_terms.csv')
