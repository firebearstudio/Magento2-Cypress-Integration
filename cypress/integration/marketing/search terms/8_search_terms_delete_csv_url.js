context('Import Search Terms', () => {
    it('delete - csv - url - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Search Terms Import - delete - csv - url')
            .should('have.value', 'Search Terms Import - delete - csv - url')
        ...
        cy.get('@urlFilePath')
            .type('http://alex-union.dev.firebearstudio.com/media/importexport/test/search_terms.csv')
            .should('have.value', 'http://alex-union.dev.firebearstudio.com/media/importexport/test/search_terms.csv')
