context('Import Search Terms', () => {
    it('add - csv - google sheet - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Search Terms Import - add - csv - google sheet')
            .should('have.value', 'Search Terms Import - add - csv - google sheet')
        ...
        cy.get('@googleFilePath')
            .invoke('val', 'https://docs.google.com/spreadsheets/d/13FemIzzexF5koAdQYjbcKscqoCfXyknYWkQkbSZGPsk/edit#gid=468296652')
            .trigger('change')
