context('Import Review', () => {
    it('delete- csv - sftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Review Import - delete - csv - sftp')
            .should('have.value', 'Review Import - delete - csv - sftp')
        ...
        cy.get('@sftpFilePath')
            .type('/var/www/alex/files/test/export_reviews_add_update.csv')
            .should('have.value', '/var/www/alex/files/test/export_reviews_add_update.csv')
