context('Import Search Synonyms', () => {
    it('add - ods - dropbox - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Search Synonyms Import - add  - ods - dropbox')
            .should('have.value', 'Search Synonyms Import - add  - ods - dropbox')
        ...
        cy.get('@dropboxFilePath')
            .type('/search_synonyms.ods').should('have.value', '/search_synonyms.ods')
