context('Import Search Synonyms', () => {
    it('add update - csv - google sheet - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Search Synonyms Import - add update - csv - google sheet')
            .should('have.value', 'Search Synonyms Import - add update - csv - google sheet')
        ...
        cy.get('@googleFilePath')
            .invoke('val', 'https://docs.google.com/spreadsheets/d/13FemIzzexF5koAdQYjbcKscqoCfXyknYWkQkbSZGPsk/edit#gid=23484138')
            .trigger('change')
