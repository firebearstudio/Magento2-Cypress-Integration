context('Import Search Synonyms', () => {
    it('delete - export file - csv - sftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Search Synonyms Import - export file - delete - csv - sftp')
            .should('have.value', 'Search Synonyms Import - export file - delete - csv - sftp')
        ...
        cy.get('@sftpFilePath')
            .type('/var/www/alex/files/test/export_search_synonyms.csv')
            .should('have.value', '/var/www/alex/files/test/export_search_synonyms.csv')
        ...
        cy.get('@goToSearchSynonymsGrid').click({force:true})
