context('Import Search Synonyms', () => {
    it('delete - csv - url - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Search Synonyms Import - delete - csv - url')
            .should('have.value', 'Search Synonyms Import - delete - csv - url')
        ...
        cy.get('@urlFilePath')
            .type('http://alex-union.dev.firebearstudio.com/media/importexport/test/search_synonyms.csv')
            .should('have.value', 'http://alex-union.dev.firebearstudio.com/media/importexport/test/search_synonyms.csv')
