context('Import Search Synonyms', () => {
    it(' add  - map - csv - file - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Search Synonyms Import - add - map - csv - file')
            .should('have.value', 'Search Synonyms Import - add - map - csv - file')
        ...
        cy.get('@filePath')
            .type('pub/media/importexport//s/e/search_synonyms_map.csv')
            .should('have.value', 'pub/media/importexport//s/e/search_synonyms_map.csv')
        ...
        cy.get('@sourceDataImport').select('store_id_new');
        ...
        cy.get('#debug-run').contains('Entity search_synonyms',{timeout: 60000})
