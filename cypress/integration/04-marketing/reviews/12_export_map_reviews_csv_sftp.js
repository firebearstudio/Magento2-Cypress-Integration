context('Export Reviews Mapping 12', () => {
    it('csv - sftp - new job', () => {
        //login
        ...
        cy.get('.general_title ').find('input')
            .type('Review Export - csv - mapping - sftp')
            .should('have.value', 'Review Export - csv - mapping - sftp')
        ...
        cy.specifySftpSource('exportSftp' , '/chroot/home/a0563af8/develop-gold.dev.firebearstudio.com/pub/media/importexport/test/export_reviews_add_update_map.csv')
