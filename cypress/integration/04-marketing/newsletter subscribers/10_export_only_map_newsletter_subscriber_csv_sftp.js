context('Export Newsletter Subscribers Only Mapping 10', () => {
    it('csv - sftp - new job', () => {
        //login
        ...
        cy.specifySftpSource('exportSftp' , '/chroot/home/a0563af8/develop-gold.dev.firebearstudio.com/pub/media/importexport/test/export_newsletter_subscribers_only_map.csv')
        ...
        cy.get('@sourceDataImport')
            .type('_map')
            .should('have.value', 'subscriber_email_map');
