...
context('Export Newsletter Subscribers Json Sftp 15', () => {
    it('json - sftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Newsletter Subscribers Export - json - sftp')
            .should('have.value', 'Newsletter Subscribers Export - json - sftp')
