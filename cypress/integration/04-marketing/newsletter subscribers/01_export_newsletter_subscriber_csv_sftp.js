context('Export Newsletter Subscribers Csv Sftp 1', () => {
    it('csv - sftp - new job', () => {
        //login
        ...
        cy.specifySftpSource('exportSftp' , '/chroot/home/a0563af8/develop-gold.dev.firebearstudio.com/pub/media/importexport/test/export_newsletter_subscribers.csv')
