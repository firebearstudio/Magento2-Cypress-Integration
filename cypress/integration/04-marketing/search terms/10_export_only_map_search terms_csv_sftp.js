context('Export Search Terms Only Mapping 10', () => {
    it('csv - sftp - new job', () => {
        //login
        ...
        cy.specifySftpSource('exportSftp' , '/chroot/home/a0563af8/develop-gold.dev.firebearstudio.com/pub/media/importexport/test/export_search_terms_only_map.csv')
