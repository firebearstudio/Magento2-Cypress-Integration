context('Import Shared Catalog', () => {
    it('delete - csv - url - new job', () => {
        ...
        cy.generalImportSection('Shared Catalog Import - delete - csv - url')
        ...
        cy.urlSource('http://alex-union.dev.firebearstudio.com/media/importexport/test/b2b_shared_catalogs.csv')
