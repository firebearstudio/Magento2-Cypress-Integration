context('Import Req List', () => {
    it('delete - csv - url - new job', () => {
        ...
        cy.generalImportSection('Req List Import - delete - csv - url')
        ...
        cy.urlSource('http://alex-union.dev.firebearstudio.com/media/importexport/test/b2b_requisition_lists.csv')
