...
context('Import Products', () => {
    it('add update - physical gift card', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Physical Gift Card Import - add update - google sheet')
        ...
        cy.get('[data-index="gift_wrapping_price"]').find('input').should('have.value','14.00')
    })
})
