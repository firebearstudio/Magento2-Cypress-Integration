...
context('Import Products Images Dropbox Source', () => {
    it('import products - images - dropbox - use image import source', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Product Import - images - dropbox - use image import source')
        ...
        cy.dropboxSource('/products_use__image_import_source.csv')
        cy.get('[data-index="dropbox_remote_images_file_dir"]').find('input').as('imagesFilePath')
        cy.get('@imagesFilePath').invoke('val','/m/b/').trigger('change',{force:true})
