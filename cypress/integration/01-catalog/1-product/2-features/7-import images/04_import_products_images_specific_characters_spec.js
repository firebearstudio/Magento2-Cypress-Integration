...
context('Import Products Images 4', () => {
    it('import - products - images - specific characters', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Product Import - images - specific characters')
        ...
        cy.fileSource('pub/media/importexport/test/products_with_images_special_characters.csv')
        cy.get('[data-index="file_import_images_file_dir"]').find('input').type('pub/media/importexport/test/image/')
