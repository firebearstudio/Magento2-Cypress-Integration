...
context('Import Products Custom logic Visibility Catalog/Search With Parent 17',{ retries: 0 }, () => {
    it('custom logic - visibility - Catalog/Search - With parent', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Product Import - custom logic - visibility - Catalog/Search - WITH parent')
