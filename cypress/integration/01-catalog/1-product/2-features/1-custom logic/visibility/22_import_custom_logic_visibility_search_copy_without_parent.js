...
context('Import Products Custom logic Visibility Search  Copy Without Parent 22',{ retries: 0 }, () => {
    it('custom logic - visibility - Search - copy - without parent', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Product Import - custom logic - copy - visibility - search  - Without parent')
        ...
        cy.fileSource('pub/media/importexport/test/products_custom_logic_visibility_search_without_parent.csv')
