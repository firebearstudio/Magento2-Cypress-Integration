...
context('Import Products Custom logic Visibility Not visible Without Parent 12',{ retries: 0 }, () => {
    it('custom logic - visibility - not visible - without parent', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Product Import - custom logic - visibility - not visible  - Without parent')
