...
context('Import Products', () => {
    it('product url pattern - new job', () => {
        ...
        cy.get('body').contains('product-url-pattern1',{timeout: 60000})
        ...
        cy.get('body').contains('product-url-pattern2',{timeout: 60000})
        ...
        cy.get('.page-actions-buttons').find('#back').click({force:true});
        cy.get('body').contains('product-url-pattern3',{timeout: 60000})
