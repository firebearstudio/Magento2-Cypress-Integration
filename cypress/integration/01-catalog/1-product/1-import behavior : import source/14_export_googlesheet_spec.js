...
context('Export Products GoogleSheet 16',() => {
    it('export - googlesheet - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Product Export - googlesheet')
            .should('have.value', 'Product Export - googlesheet')
        ...
        cy.get('[name="export_source_google_spreadsheet_id"]').type('1mzKGoCba6-11DK1gYpMDBaes_s42lI1WR0MeT1VeCrU')
        cy.get('[name="export_source_google_sheet_id"]').type('0')
