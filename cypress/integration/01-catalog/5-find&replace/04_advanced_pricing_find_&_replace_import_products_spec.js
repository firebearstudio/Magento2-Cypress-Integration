...
context('Import Products/Advanced Prcing', () => {
    it(' find and replace - csv - file - new job', () => {
        ...
        cy.generalImportSectionWithoutReIndex('Products/Advanced Pricing Import - find and replace - csv - file')
        ...
        cy.fileSource('pub/media/importexport/test/product_for_advanced_pricing.csv')
