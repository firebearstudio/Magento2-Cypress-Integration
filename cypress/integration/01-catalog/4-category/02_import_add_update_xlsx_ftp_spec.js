context('Import Сategories Using Export File 2', () => {
    it('add update - xlsx - sftp - new job', () => {
        ...
        cy.specifySftpSource('importSftp','/chroot/home/a0563af8/develop-gold.dev.firebearstudio.com/pub/media/importexport/test/var/export_categories.xlsx',{force:true})
