context('Import Attributes', () => {
    it('replace - csv - sftp - new job', () => {
        ...
        cy.specifySftpSource('importSftp','/chroot/home/a0563af8/develop-cypress.dev.firebearstudio.com/pub/media/importexport/test/attributes_replace.csv',{force:true})
