context('Export Advanced Pricing Mapping 13', () => {
    it('xlsx - sftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Advanced Pricing Export - mapping - xlsx - sftp')
            .should('have.value', 'Advanced Pricing Export - mapping - xlsx - sftp')
        ...
        cy.specifySftpSource('exportSftp' , '/chroot/home/a0563af8/develop-gold.dev.firebearstudio.com/pub/media/importexport/test/var/export_advanced_pricing_map.xlsx')
        ...
        cy.get('@sourceDataImport')
            .type('_map')
            .should('have.value', 'tier_price_qty_map');
