context('Import Сustomer Delete Finances Using Export File 2', () => {
    it('delete - exportFile - ods - sftp - new job', () => {
        //login
        ...
        cy.generalImportSection('Customer Finances Import - delete - using export file')
