...
context('Import Customers and Addresses Delete Ods Sftp', () => {
    it('delete - ods - sftp - new job', () => {
        ...
        cy.generalImportSection('Customer and Addresses Import - delete - ods - sftp')
        ...
        cy.specifySftpSource('importSftp','/chroot/home/a0563af8/develop-gold.dev.firebearstudio.com/pub/media/importexport/test/customers_and_addresses.ods')
