...
context('Import Сustomer Addresses Add Update Csv Url 7', () => {
    it('add update - csv - url - new job', () => {
        ...
        cy.generalImportSection('Customer Address Import - add update - csv - url')
        ...
        cy.urlSource('https://48a8a91726-1275736.nxcli.net/media/importexport/test/customer_addresses.csv')
