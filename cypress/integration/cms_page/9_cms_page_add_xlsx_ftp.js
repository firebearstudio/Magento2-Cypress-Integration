context('Import Cms Page', () => {
    it('add - xlsx - ftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Cms Page Import - add - xlsx - ftp')
            .should('have.value', 'Cms Page Import - add - xlsx - ftp')
        ...
        cy.get('@ftpFilePath')
            .type('/files/test/cms_pages.xlsx')
            .should('have.value', '/files/test/cms_pages.xlsx')
