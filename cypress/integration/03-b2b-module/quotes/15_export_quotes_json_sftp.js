context('Export Quotes Json 15', () => {
    it('json - sftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Quotes Export - json - sftp')
            .should('have.value', 'Quotes Export - json - sftp')
        ...
        cy.specifySftpSource('exportSftp','/chroot/home/a0563af8/develop-alpha.dev.firebearstudio.com/pub/media/importexport/test/var/export_quote.json')
