context('Export Quotes Xml 13', () => {
    it('xml - sftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Quotes Export - xml - sftp')
            .should('have.value', 'Quotes Export - xml - sftp')
        ...
        cy.specifySftpSource('exportSftp','/chroot/home/a0563af8/develop-alpha.dev.firebearstudio.com/pub/media/importexport/test/var/export_quote.xml')
