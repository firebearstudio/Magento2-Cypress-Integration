context('Export Quote Only Map 11', () => {
    it('csv - sftp - new job', () => {
        //login
        ...
        cy.get('.general_title ').find('input')
            .type('Quote Export - Only map - csv - sftp')
            .should('have.value', 'Quote Export - Only map - csv - sftp')
        ...
        cy.specifySftpSource('exportSftp','/chroot/home/a0563af8/develop-alpha.dev.firebearstudio.com/pub/media/importexport/test/var/export_quote_only_map.csv')
