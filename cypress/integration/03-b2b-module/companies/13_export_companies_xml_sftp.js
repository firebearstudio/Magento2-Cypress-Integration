context('Export Companies Xml File 13', () => {
    it('xml - sftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Companies Export - xml - sftp')
            .should('have.value', 'Companies Export - xml - sftp')
        ...
        cy.specifySftpSource('exportSftp','/chroot/home/a0563af8/develop-alpha.dev.firebearstudio.com/pub/media/importexport/test/var/export_companies.xml')
