context('Import Companies Add Update Xlsx Ftp 8', () => {
    it('add update - xlsx - ftp - new job', () => {
        ...
        cy.generalImportSection('Companies Import - add update - xlsx - ftp')
        ...
        cy.ftpSource('importFtp','/files/b2b_companies.xlsx')
