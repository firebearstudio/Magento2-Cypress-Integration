context('Export Companies Mapping 12', () => {
    it('csv - sftp - new job', () => {
        //login
        ...
        cy.get('.general_title ').find('input')
            .type('Companies Export Map - csv - sftp')
            .should('have.value', 'Companies Export Map - csv - sftp')
        ...
        cy.specifySftpSource('exportSftp','/chroot/home/a0563af8/develop-alpha.dev.firebearstudio.com/pub/media/importexport/test/var/export_company_mapping.csv')
