context('Export Companies Ods File 14', () => {
    it('ods - sftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Companies Export - ods - sftp')
            .should('have.value', 'Companies Export - ods - sftp')
        ...
        cy.specifySftpSource('exportSftp','/chroot/home/a0563af8/develop-alpha.dev.firebearstudio.com/pub/media/importexport/test/var/export_companies.ods')
