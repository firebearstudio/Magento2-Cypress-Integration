context('Export Req List Xml Sftp 12', () => {
    it('xml - sftp - new job', () => {
        //login
        ...
        cy.get('.general_title ').find('input')
            .type('Req List Export - xml - sftp')
            .should('have.value', 'Req List Export - xml - sftp')
        ...
        cy.specifySftpSource('exportSftp','/chroot/home/a0563af8/develop-alpha.dev.firebearstudio.com/pub/media/importexport/test/var/b2b_req_list.xml')
