context('Export Req List Only Map 14', () => {
    it('csv - sftp - new job', () => {
        //login
        ...
        cy.get('.general_title ').find('input')
            .type('Req List Export - Only map - csv - sftp')
            .should('have.value', 'Req List Export - Only map - csv - sftp')
        ...
        cy.specifySftpSource('exportSftp','/chroot/home/a0563af8/develop-alpha.dev.firebearstudio.com/pub/media/importexport/test/var/export_req_list_map.csv')
