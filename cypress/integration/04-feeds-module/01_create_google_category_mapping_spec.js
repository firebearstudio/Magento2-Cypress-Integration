...
context('Create Google Category Mapping 1',() => {
    it('create google category mapping', () => {
        //login
        ...
        cy.get('[data-index="title"]').find('input').type('Google Feed',{force: true})
        cy.get('[data-index="type_id"]').find('select').select('Google',{force: true})
