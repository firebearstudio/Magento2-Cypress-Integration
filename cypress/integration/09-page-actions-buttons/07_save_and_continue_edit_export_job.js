context('Save And Continue Edit Export Jobs', () => {
    it('add update - csv - google sheet - new job', () => {
        ...
        //click on the 'Save and Continue Edit' export job button
        cy.get('.page-actions-buttons',{timeout: 10000}).find('#save_and_continue').click({force:true})
