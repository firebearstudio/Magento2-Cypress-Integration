...
context('Import Orders', () => {
    it('delete - ods - ftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Orders Import - delete - ods - ftp')
            .should('have.value', 'Orders Import - delete - ods - ftp')
        ...
        cy.get('@ftpFilePath')
            .type('/files/import_orders_delete.ods')
            .should('have.value', '/files/import_orders_delete.ods')
