...
context('Import Orders', () => {
    it('replace - csv - sftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Orders Import - replace - csv - sftp')
            .should('have.value', 'Orders Import - replace - csv - sftp')
        ...
        cy.get('@sftpFilePath')
            .type('/var/www/alex/files/import_orders_replace.csv')
            .should('have.value', '/var/www/alex/files/import_orders_replace.csv')
