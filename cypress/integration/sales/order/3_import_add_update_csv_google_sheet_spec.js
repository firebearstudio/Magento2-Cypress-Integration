...
context('Import Orders', () => {
    it('add update - csv - google sheet - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Orders Import - add update - csv - google sheet')
            .should('have.value', 'Orders Import - add update - csv - google sheet')
        ...
        cy.get('@googleFilePath')
            .invoke('val', 'https://docs.google.com/spreadsheets/d/13FemIzzexF5koAdQYjbcKscqoCfXyknYWkQkbSZGPsk/edit#gid=1012924129')
            .trigger('change')
