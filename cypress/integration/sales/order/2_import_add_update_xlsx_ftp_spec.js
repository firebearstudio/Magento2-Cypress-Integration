...
context('Import Orders', () => {
    it('add update - xlsx - ftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Orders Import - add update - xlsx - ftp')
            .should('have.value', 'Orders Import - add update - xlsx - ftp')
        ...
        cy.get('@ftpFilePath')
            .type('/files/import_orders_add_update_sample_data.xlsx')
            .should('have.value', '/files/import_orders_add_update_sample_data.xlsx')
