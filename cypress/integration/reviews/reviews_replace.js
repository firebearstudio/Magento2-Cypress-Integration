context('Import Reviews', () => {
    it('replace - csv - sftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Review Import - replace - csv - sftp')
            .should('have.value', 'Review Import - replace - csv - sftp')
        ...
        cy.get('@sftpFilePath')
            .type('/var/www/alex/files/reviews_replace_csv_sftp.csv')
            .should('have.value', '/var/www/alex/files/reviews_replace_csv_sftp.csv')
