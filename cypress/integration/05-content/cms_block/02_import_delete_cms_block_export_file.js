context('Import Cms Block Delete Export File 2', () => {
    it('delete - export file - csv - sftp - new job', () => {
        ...
        cy.generalImportSectionWithoutReIndex('Cms Block Import - export file - delete - csv - sftp')
        ...
        //check that cms blocks were deleted
        ...
        cy.get('.admin__control-support-text',{timeout: 20000}).contains('0',{timeout: 30000})
    })
})
