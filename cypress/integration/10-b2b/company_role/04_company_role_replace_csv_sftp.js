context('Import Company Roles Replace Csv File 4', () => {
    it('company - csv - file - new job', () => {
        ...
        cy.generalImportSection('Company Roles Import - replace - csv - file')
        ...
        cy.fileSource('pub/media/importexport/test/b2b_company_roles_test.csv')
