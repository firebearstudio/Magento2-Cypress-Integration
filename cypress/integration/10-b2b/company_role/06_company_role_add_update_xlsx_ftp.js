context('Import Company Roles Add Update Xlsx Ftp 6', () => {
    it('add update - xlsx - ftp - new job', () => {
        ...
        cy.generalImportSection('Company Roles Import - add update - xlsx - ftp')
        ...
        cy.ftpSource('importFtp','/files/b2b_company_roles_test.csv')
