context('Import Req list Add Update Json Sftp 11', () => {
    it(' add update - json - sftp - new job', () => {
        ...
        cy.generalImportSectionWithoutReIndex('Req list Import - add update - json - sftp')
        ...
        cy.specifySftpSource('importSftp','/chroot/home/a0563af8/develop-gold.dev.firebearstudio.com/pub/media/importexport/test/var/b2b_req_list.json')
