context('Import Сustomer Finances', () => {
    it('add update - exportFile - ods - sftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Customer Finances Import - add update - ods - sftp')
            .should('have.value', 'Customer Finances Import - add update - ods - sftp')
        ...
        cy.get('@behaviorBehavior').select('add_update');
         ...
         cy.get('@sftpFilePath')
             .type('/var/www/alex/files/test/export_customer_finances_add_update.ods')
             .should('have.value', '/var/www/alex/files/test/export_customer_finances_add_update.ods')
