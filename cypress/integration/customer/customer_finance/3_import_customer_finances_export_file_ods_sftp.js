context('Import Сustomer Finances', () => {
    it('add update - exportFile - ods - sftp - new job', () => {
        ...
        cy.generalImportSection('Customer Finances Import - add update - ods - sftp')
        ...
        cy.get('@behaviorBehavior').select('add_update');
         ...
         cy.specifySftpSource('importSftp','/var/www/alex/files/test/export_customer_finances_add_update.ods')
