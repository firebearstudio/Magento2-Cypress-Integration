...
context('Import Сustomer Addresses', () => {
    it('add update - csv - google sheet - new job', () => {
        ...
        cy.generalImportSection('Customer Address Import - add update - csv - google sheet')
        ...
        cy.googlePathSource('https://docs.google.com/spreadsheets/d/13FemIzzexF5koAdQYjbcKscqoCfXyknYWkQkbSZGPsk/edit#gid=467742921')
