...
context('Import Сustomers', () => {
    it('add update - xml - file - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Сustomer Import - add update - xml - file').should('have.value', 'Сustomer Import - add update - xml - file')
        ...
        cy.get('@filePath')
            .type('pub/media/importexport/import_customers_add_update.xml')
            .should('have.value', 'pub/media/importexport/import_customers_add_update.xml')
