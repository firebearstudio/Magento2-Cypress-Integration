...
context('Import Сustomers', () => {
    it('add update - csv - sftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Сustomer Import - add update - csv - sftp')
            .should('have.value', 'Сustomer Import - add update - csv - sftp')
        ...
        cy.get('@sftpFilePath')
            .type('/var/www/alex/files/import_customers_add_update.csv')
            .should('have.value', '/var/www/alex/files/import_customers_add_update.csv')
