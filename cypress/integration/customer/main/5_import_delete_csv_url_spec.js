...
context('Import Сustomers', () => {
    it('delete - csv - url - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Сustomer Import - delete - csv - url')
            .should('have.value', 'Сustomer Import - delete - csv - url')
        ...
        cy.get('@urlFilePath')
            .type('http://import.com/pub/media/importexport/import_customers_delete.csv')
            .should('have.value', 'http://import.com/pub/media/importexport/import_customers_delete.csv')
