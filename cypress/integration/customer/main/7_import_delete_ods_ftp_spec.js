...
context('Import Сustomers', () => {
    it('delete - ods - ftp - new job', () => {
        ...
        cy.get('.general_title ').find('input')
            .type('Сustomer Import - delete - ods - ftp')
            .should('have.value', 'Сustomer Import - delete - ods - ftp')
        ...
        cy.get('@ftpFilePath')
            .type('/files/import_customers_delete.ods')
            .should('have.value', '/files/import_customers_delete.ods')
        ...
        cy.get('.admin__data-grid-outer-wrap').contains('2 records found',{timeout: 60000});
    })
})
