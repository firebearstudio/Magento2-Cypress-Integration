...
context('Export Reviews Google Drive 9',() => {
    it('export - review - google drive - new job', () => {
        //login
        ...
        cy.get('.general_title ').find('input')
            .type('Review Export - google drive')
            .should('have.value', 'Review Export - google drive')
        ...
        cy.get('[data-index="export_source_googledrive_file_path"]').find('input')
            .type('new/review-google-drive-test.xlsx',{force:true})
            .should('have.value','new/review-google-drive-test.xlsx')
