...
context('Import Customer Main Google Drive 14', () => {
    it('import customer main - google drive - new job', () => {
        //login
        ...
        cy.generalImportSectionWithoutReIndex('Customer Main Import - add update - csv - google drive')
        ...
        cy.get('[data-index="googledrive_googledrive_file_path"]').find('input')
            .type('new/customers_main.csv',{force:true})
            .should('have.value','new/customers_main.csv')
